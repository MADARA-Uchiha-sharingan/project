...
export class MemStorage implements IStorage {
  ...
  private async initializeData() {
    ...
    await this.createMenuItem({
      ...
      image: "https://i.ibb.co/R4V9wDYD/Egg-Fried-Noodles.webp",
      categoryId: noodles.id,
      isFeatured: false,
      spiceLevel: "Medium",
      prepTime: "15 mins"
    ...
    await this.createMenuItem({
      ...
      image: "https://i.ibb.co/CKn7JrNM/Veg-Fried-Noodles.webp",
      categoryId: macaroni.id,
      isFeatured: false,
      spiceLevel: "Medium",
      prepTime: "18 mins"
    ...
    await this.createMenuItem({
      ...
      image: "https://i.ibb.co/bgT2fJWK/Veg-Chowmein.webp",
    ...
    await this.createMenuItem({
      ...
      image: "https://i.ibb.co/jvnt2xpp/Jhol-momo.webp",
      categoryId: momo.id,
      isFeatured: false,
      spiceLevel: "Medium",
      prepTime: "25 mins"
    ...
    await this.createMenuItem({
      ...
      image: "https://i.ibb.co/0ynDHM0s/Steamed-Veg-Mo-MO.webp",
      categoryId: momo.id,
      isFeatured: true,
      spiceLevel: "Varies",
      prepTime: "35 mins"
    ...
    await this.createMenuItem({
      ...
      image: "https://i.ibb.co/JFk5y2Zm/Sausage-fry.webp",
    ...
    await this.createMenuItem({
      ...
      image: "https://i.ibb.co/zWm6FWqZ/Onion-Pakora.webp",
      categoryId: sausageTofu.id,
      isFeatured: false,
      spiceLevel: "Mild",
      prepTime: "20 mins"
    ...
    await this.createMenuItem({
      ...
      image: "https://i.ibb.co/r2jfwthF/Paneer-Pakora.webp",
      categoryId: sausageTofu.id,
      isFeatured: false,
      spiceLevel: "Mild",
      prepTime: "18 mins"
    ...
    await this.createMenuItem({
      ...
      image: "https://i.ibb.co/nsTSFFvG/Chicken-fry.webp",
    ...
    await this.createMenuItem({
      ...
      image: "https://i.ibb.co/Kzbb6bKH/Fish-Fry.webp",
      categoryId: friedSekuwa.id,
      isFeatured: true,
      spiceLevel: "Medium",
      prepTime: "25 mins"
    ...
    await this.createMenuItem({
      ...
      image: "https://i.ibb.co/2395W5Sg/Veg-khana-set.webp",
    ...
    await this.createMenuItem({
      ...
      image: "https://i.ibb.co/VcHCP9GQ/Mutton-Khana-set.webp",
      categoryId: khanaSet.id,
      isFeatured: true,
      spiceLevel: "Hot",
      prepTime: "35 mins"
    ...
    await this.createMenuItem({
      ...
      image: "https://i.ibb.co/7xxrKM4h/Rice-Pudding.webp",
      categoryId: saladsSnacks.id,
      isFeatured: true,
      spiceLevel: "None",
      prepTime: "15 mins"
    ...
    await this.createMenuItem({
      ...
      image: "https://i.ibb.co/D3LF9fN/Black-Coffee.webp",
