...
export class MemStorage implements IStorage {
  ...
  private async initializeData() {
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Lemon Tea.png", // Using lemon tea image as placeholder
      categoryId: teaBeverages.id,
      isFeatured: false,
      spiceLevel: "None",
      prepTime: "3 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Plain lassi.png", // Using plain lassi image as placeholder
      categoryId: teaBeverages.id,
      isFeatured: false,
      spiceLevel: "None",
      prepTime: "2 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Gorkha Mini beer.png",
      categoryId: hardDrinks.id,
      isFeatured: false,
      spiceLevel: "None",
      prepTime: "1 min"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Khukuri Rum XXX.png",
      categoryId: hardDrinks.id,
      isFeatured: false,
      spiceLevel: "None",
      prepTime: "2 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Old Durbar whiskey.png",
      categoryId: hardDrinks.id,
      isFeatured: true,
      spiceLevel: "None",
      prepTime: "2 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Toasted Bread and omlete.png",
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Toasted Bread with Honey and Jam and Omelette.png",
      categoryId: breakfast.id,
      isFeatured: false,
      spiceLevel: "None",
      prepTime: "7 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Omelette and Paratha.png",
      categoryId: breakfast.id,
      isFeatured: true,
      spiceLevel: "Mild",
      prepTime: "15 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Paneer Pakora.png",
      categoryId: breakfast.id,
      isFeatured: false,
      spiceLevel: "Mild",
      prepTime: "15 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Mushroom Pakora.png",
      categoryId: breakfast.id,
      isFeatured: true,
      spiceLevel: "Mild",
      prepTime: "15 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Egg Noodle Soup.png",
      categoryId: noodles.id,
      isFeatured: false,
      spiceLevel: "Mild",
      prepTime: "15 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Veg Fried Noodles.png",
      categoryId: noodles.id,
      isFeatured: true,
      spiceLevel: "Medium",
      prepTime: "15 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Egg Fried Noodles.png",
      categoryId: noodles.id,
      isFeatured: false,
      spiceLevel: "Medium",
      prepTime: "15 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Egg Fried Noodles.png", // Using egg noodles image as placeholder
      categoryId: noodles.id,
      isFeatured: true,
      spiceLevel: "Medium",
      prepTime: "20 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Egg Fried Noodles.png", // Using noodle image as placeholder
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Veg Fried Noodles.png", // Using veg noodles image as placeholder
      categoryId: macaroni.id,
      isFeatured: false,
      spiceLevel: "Medium",
      prepTime: "18 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Veg Chowmein.png", // Using veg chowmein image as placeholder
      categoryId: chowmein.id,
      isFeatured: false,
      spiceLevel: "Medium",
      prepTime: "18 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Veg Thuppa.png", // Using veg thukpa image as placeholder
      categoryId: thukpa.id,
      isFeatured: true,
      spiceLevel: "Medium",
      prepTime: "25 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Steamed Veg MoMO.png",
      categoryId: momo.id,
      isFeatured: true,
      spiceLevel: "Mild",
      prepTime: "25 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Steamed Veg MoMO.png", // Using veg momo image as placeholder
      categoryId: momo.id,
      isFeatured: false,
      spiceLevel: "Medium",
      prepTime: "25 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/spicy fried chilli momo.png", // Using chili momo image as placeholder
      categoryId: momo.id,
      isFeatured: false,
      spiceLevel: "Medium",
      prepTime: "30 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/spicy fried chilli momo.png",
      categoryId: momo.id,
      isFeatured: true,
      spiceLevel: "Hot",
      prepTime: "30 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Onion Pakora.png", // Using pakora image as placeholder
      categoryId: sausageTofu.id,
      isFeatured: false,
      spiceLevel: "Mild",
      prepTime: "20 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Paneer Pakora.png", // Using paneer image as placeholder
      categoryId: sausageTofu.id,
      isFeatured: false,
      spiceLevel: "Mild",
      prepTime: "18 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Chicken fry.png", // Using chicken fry image as placeholder
      categoryId: friedSekuwa.id,
      isFeatured: false,
      spiceLevel: "Hot",
      prepTime: "30 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Fish Fry.png", // Using fish fry image as placeholder
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Veg khana set.png", // Using veg khana image as placeholder
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Veg khana set.png",
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Mutton Khana set.png",
      categoryId: khanaSet.id,
      isFeatured: true,
      spiceLevel: "Hot",
      prepTime: "35 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Rice Pudding.png", // Using rice pudding image as placeholder
      categoryId: saladsSnacks.id,
      isFeatured: true,
      spiceLevel: "None",
      prepTime: "15 mins"
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Black Coffee.png", // Using placeholder image
    ...
    await this.createMenuItem({
      ...
      image: "/assets/Black Coffee.png", // Using coffee image as placeholder
